#!/usr/bin/env bash
# =============================================================================
# run_sim_100k_diploid.sh — Behavioral Genetics paper figure data
#
# Runs the 100k-tick diploid (codominant) simulation that anchors
# §sec:eval-diploid in the paper. Saves to chunked sim_log files.
#
# Note: under v0.1.7+ per-allele dominance scoring, DOMINANT and CODOMINANT
...
#   ./run_sim_100k_diploid.sh --base-url http://host:port/v1   # remote LLM
# =============================================================================
...
OUTPUT="${OUTPUT:-sim_log_diploid_codominant.json}"
...
echo "=========================================="
echo "  100k Diploid (codominant) Simulation"
echo "=========================================="
